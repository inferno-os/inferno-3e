...
F_ALPHABET, F_CUT, F_DEL, F_DELCOL, F_DUMP, F_EDIT, F_EXITX, F_FONTX, F_GET, F_ID, F_INCL, F_KILL, F_LINENO, F_LOCAL, F_LOOK, F_NEW, F_NEWCOL, F_PASTE, F_PUT, F_PUTALL, F_UNDO, F_SEND, F_SORT, F_TAB, F_ZEROXX : con iota;
...
exectab := array[] of {
	...
	Exectab ( "Zerox",		F_ZEROXX,	FALSE,	XXX,		XXX		),
	Exectab ( nil, 			0,			0,		0,		0		),
};
...
putfile(f: ref File, q0: int, q1: int, name: string)
{
	...
	(ok, d) = sys->fstat(fd);
	if(ok>=0 && (d.mode&CHAPPEND) && d.length>0){
