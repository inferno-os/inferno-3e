...
Frame: adt
{
	...
	viewr: Draw->Rect;			# view: subrect of pager currently on screen
	...
	focus: fn(f : self ref Frame, focus, raise : int);
};
...
#			onchange:	int;		# true if want onchange event
	...
	losefocus: fn(b: self ref Control, raise: int);
	gainfocus: fn(b: self ref Control, raise: int);
