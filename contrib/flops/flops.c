...
cc -O3 flops.c -o flops
cc -O0 flops.c -o flops
cc -O3 -r10000 -64 -IPA
   -OPT:fast_sqrt=ON:alias=restrict:roundoff=3:fast_exp=ON:fast_io=ON:ptr_opt=ON
   -GCM:aggressive_speculation=ON:static_load_speculation=ON
   -OPT:unroll_bblimit=30:unroll_size=1000:unroll_times_max=8
   -LIST:=ON
   flops.c -o flops

On Sun:

/solaris/SPARCworks/SUNWspro/bin/cc -fast flops.c -o flops
...
/*------ End flops.c code, say good night Carol! (Sep 1992) ------*/
