...
#define BCKN(r, rb)	(CMN(AL, rb, 0, 0, r), CCALL(HS, bounds))
#define BCKNI(i, rb)	(CMNI(AL, rb, 0, 0, i), CCALL(HS, bounds))
...
} mactab[] =
{
	...
	MacECLR,		maceclr, "ECLR",	/* exception patcher */
...
*/
	...
	case IINDB:
		...
		/* TBS mem(Ldw, O(Array, len), RA0, RA2); */
		r = 0;
		switch(i->op) {
		case IINDL:
		case IINDF:
