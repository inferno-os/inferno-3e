enum
{
	...
	OPTevim,		/* Image as color; aux is index into colour table */
	...
	Frameinset	= 0,	/* Frame inset left at box edges (was 2) */
...
extern	char*		tkdrawstring(Tk*, Image*, Point, char*, int, int, int);
...
extern	void		tksetmgrab(TkCtxt*, Tk*);
...
extern	void		tkmkpen(Image**, TkEnv*, TkEnv*, Image*);
extern	void		tkmkstipple(Image*);
extern	int		tkmkmask(TkCanvas*, Image*, TkCitem*, Point*);
...
extern	TkCtxt*		tkattachctxt(Screen*);
...
extern	char*	tkcvsgrab(Tk*, char*, char **);
extern	char* 	tkcvscreate(Tk*, char*, char **);
extern	char* 	tkcvscanvx(Tk*, char*, char **);
extern	char* 	tkcvscanvy(Tk*, char*, char **);
extern	char* 	tkcvsscreenx(Tk*, char*, char **);
extern	char* 	tkcvsscreeny(Tk*, char*, char **);
...
extern	char*	tkcvssee(Tk*, char*, char**);
...
extern	void	tkeprnt(int, char*, char*);
extern	void		tkprintevent(int e);
extern	void	tkerr(TkTop*, char*);
extern	char*	tkerrstr(TkTop*, char*);
extern	void	tksenderr(TkTop*, char*, char*, char*);
