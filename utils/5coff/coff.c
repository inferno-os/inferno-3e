...
// in their coff files, edata, end have type 0 not 4
// in their coff files, file value is ptr to next file sym (as mine) but their last one
// points to an external sym ?, mine to 0
...
static int
putsym(Sym *s, int sc, int t, int lno)
{
	long v;
