...
static void poolsizeinit(void);	/* XXX - Tad: hack */
void
main(void)
{
...
init0(void)
{
	...
	if(waserror())
	 ...
	 /* from /work/brucee/ppc-19-feb/os/ibox/main.c init0()
	  *
 ...
 *
 * /sys/src/9/port/alloc.c and /sys/src/9/port/page.c
