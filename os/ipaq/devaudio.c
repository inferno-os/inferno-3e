 ...
 *
 *	This code is covered by the Plan 9 Open Source Licence (http://plan9.bell-labs.com/plan9dist/license.html);
...
static long
audioread(Chan *c, void *v, long n, ulong off)
{
	int liv, riv, lov, rov;
	long m, n0;
	char buf[300];
...
static long
audiowrite(Chan *c, void *vp, long n, ulong)
{
	long m, n0;
