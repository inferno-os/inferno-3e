...
/* board-dependent GPIO pin assignment */
#define L3DataPin	(1<<14)
#define L3ModePin	(1<<15)
#define L3ClockPin	(1<<16)

/* 
 * L3 setup and hold times (expressed in us)
 */
#define L3DataSetupTime 1 /* 190 ns */
#define L3DataHoldTime  1 /*  30 ns */
#define L3ModeSetupTime 1 /* 190 ns */
#define L3ModeHoldTime  1 /* 190 ns */
#define L3ClockHighTime 1 /* 250 ns (min is 64*fs, 35us @ 44.1 Khz) */
#define L3ClockLowTime  1 /* 250 ns (min is 64*fs, 35us @ 44.1 Khz) */
#define L3HaltTime      1 /* 190 ns */
...
L3acquirepins(void)
{
	...
	s = splhi();
	g->gpsr = (L3ModePin | L3ClockPin | L3DataPin);
	g->gpdr |=  (L3ModePin | L3ClockPin | L3DataPin);
	splx(s);
//	microdelay(2);
}
...
L3init(void)
{
	...
	s = splhi();
	g->gafr &= ~(L3DataPin | L3ClockPin | L3ModePin);
	splx(s);
	L3releasepins();
}
