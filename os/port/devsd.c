...
static long
sdread(Chan *c, void *a, long n, ulong off)
{
...
static long
sdwrite(Chan *c, void *vp, long n,ulong off)
{
	Disk *d;
	char *a;
...
static long
sdio(Chan *c, int write, char *a, ulong len, ulong off)
{
	Disk *d;
	Part *p;
	uchar *b;
