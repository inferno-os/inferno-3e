...
#ifdef Plan9v3
#define	errstr	v4errstr
#define	dirstat	v4dirstat
#define	dirfstat	v4dirfstat
#define	dirwstat	v4dirwstat
#define	dirfwstat	v4dirfwstat
#define	dirread	v4dirread
#endif
...
#define	Qid	Qid9p1
#define	Dir	Dir9p1
#define	dirstat	v3dirstat
#define	dirfstat	v3dirfstat
#define	dirwstat	v3dirwstat
#define	dirfwstat	v3dirfwstat
extern	int	v3dirstat(char*, Dir9p1*);
extern	int	v3dirwstat(char*, Dir9p1*);
extern	int	v3dirfstat(int, Dir9p1*);
extern	int	v3dirfwstat(int, Dir9p1*);
#endif
